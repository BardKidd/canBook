  ...
  <div class="container">
    <div class="row shopPaddingTop">
      <div class="scheduleShowCheck col-12">
        <ul>
          <li><p>1.填寫訂購資料</p></li>
          <li :class="{'scheduleShowAnother': orderData.is_paid == 1}"><p>2.付款確認</p></li>
          <li v-if="orderData.is_paid == 0"><p>3.完成訂單</p></li>
          <li v-if="orderData.is_paid == 1" id="successOrder"><p>3.完成訂單</p></li>
        </ul>
      </div>
